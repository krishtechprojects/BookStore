...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert category and added types into the bookcategory table
    $sql_insert = "INSERT INTO bookcategory (category, addedtypes) VALUES ('$category', '$addedTypes')";
...
<head>
    ...
    <title>Add Category - The Store Of Knowledge</title>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if (isset($message)) { ?>
                            <div class="alert alert-<?php echo ($message == "Category added successfully") ? 'success' : 'danger'; ?>" role="alert">
                                <?php echo $message; ?>
                            </div>
                        <?php } ?>
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            ...
                            <div class="form-group">
                                <label for="addedtypes">Added Types</label>
                                <textarea class="form-control" id="addedtypes" name="addedtypes" rows="3"></textarea>
                            </div>
