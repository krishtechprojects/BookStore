...
// Retrieve all categories from the bookcategory table
...
<head>
    ...
    <title>View Categories - The Store Of Knowledge</title>
                            ...
                            <tbody>
                                ...
                                if ($result_categories->num_rows > 0) {
                                    while ($row_category = $result_categories->fetch_assoc()) {
                                        ...
                                        $addedTypes = $row_category["addedtypes"];
                                        ?>
                                        <tr>
                                            <td><?php echo $category; ?></td>
                                            <td><?php echo $addedTypes; ?></td>
                                            <td>
                                                <a href="DeleteCategory.php?category=<?php echo urlencode($category); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this category?')">Delete</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
